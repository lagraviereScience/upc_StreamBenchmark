...
/*******************************************************
 * C file translated from WHIRL Fri Dec  2 06:19:27 2016
 *******************************************************/
...
typedef double _type__N7_avgtime_N10_3971555194_[4];
_type__N7_avgtime_N10_3971555194_ UPCR_TLD_DEFINE(_N7_avgtime_N10_3971555194_, 32, 8) = {0.0,};
typedef double _type__N7_maxtime_N9_902110055_[4];
_type__N7_maxtime_N9_902110055_ UPCR_TLD_DEFINE(_N7_maxtime_N9_902110055_, 32, 8) = {0.0,};
typedef double _type__N7_mintime_N10_4143833508_[4];
_type__N7_mintime_N10_4143833508_ UPCR_TLD_DEFINE(_N7_mintime_N10_4143833508_, 32, 8) = {3.4028234663852886e+38,3.4028234663852886e+38,3.4028234663852886e+38,3.4028234663852886e+38,};
typedef char*  _type__N5_label_N9_441990984_[4];
_type__N5_label_N9_441990984_ UPCR_TLD_DEFINE(_N5_label_N9_441990984_, 32, 8) = {"Copy:      ","Scale:     ","Add:       ","Triad:     ",};
typedef double _type__N5_bytes_N8_35718253_[4];
_type__N5_bytes_N8_35718253_ UPCR_TLD_DEFINE(_N5_bytes_N8_35718253_, 32, 8) = {1.6e+08,1.6e+08,2.4e+08,2.4e+08,};
...
#line 86 "stream.c"
  _bupc_call0 = upc_all_alloc((unsigned long) 16ULL, (unsigned long) 5000000ULL);
#line 86 "stream.c"
  _bupc_Mstopcvt5 = UPCR_SHARED_TO_PSHARED(_bupc_call0);
#line 86 "stream.c"
  a = _bupc_Mstopcvt5;
#line 87 "stream.c"
  _bupc_call1 = upc_all_alloc((unsigned long) 16ULL, (unsigned long) 5000000ULL);
#line 87 "stream.c"
  _bupc_Mstopcvt6 = UPCR_SHARED_TO_PSHARED(_bupc_call1);
#line 87 "stream.c"
  b = _bupc_Mstopcvt6;
#line 88 "stream.c"
  _bupc_call2 = upc_all_alloc((unsigned long) 16ULL, (unsigned long) 5000000ULL);
#line 88 "stream.c"
...
#line 277 "stream.c"
      {
#line 279 "stream.c"
        (_N7_avgtime_N10_3971555194_)[j] = (_N7_avgtime_N10_3971555194_)[j] + times[j][k];
#line 280 "stream.c"
        if((_N7_mintime_N10_4143833508_)[j] < times[j][k])
#line 280 "stream.c"
        {
#line 280 "stream.c"
          _bupc_mcselect3 = (_N7_mintime_N10_4143833508_)[j];
        }
        else
#line 280 "stream.c"
        {
...
#line 280 "stream.c"
        (_N7_mintime_N10_4143833508_)[j] = _bupc_mcselect3;
#line 281 "stream.c"
        if((_N7_maxtime_N9_902110055_)[j] > times[j][k])
#line 281 "stream.c"
        {
#line 281 "stream.c"
          _bupc_mcselect4 = (_N7_maxtime_N9_902110055_)[j];
        }
        else
#line 281 "stream.c"
        {
...
#line 281 "stream.c"
        (_N7_maxtime_N9_902110055_)[j] = _bupc_mcselect4;
#line 282 "stream.c"
        _9 :;
#line 282 "stream.c"
        j = j + 1LL;
...
#line 287 "stream.c"
    {
#line 289 "stream.c"
      (_N7_avgtime_N10_3971555194_)[j] = (_N7_avgtime_N10_3971555194_)[j] / 9.0;
#line 295 "stream.c"
      printf("%s%12.1f  %11.6f  %11.6f  %11.6f\n", (_N5_label_N9_441990984_)[j], ((_N5_bytes_N8_35718253_)[j] * 1e-06) / (_N7_mintime_N10_4143833508_)[j], (_N7_avgtime_N10_3971555194_)[j], (_N7_mintime_N10_4143833508_)[j], (_N7_maxtime_N9_902110055_)[j]);
#line 296 "stream.c"
      _10 :;
#line 296 "stream.c"
      j = j + 1LL;
...
GASNETT_IDENT(UPCRI_IdentString_stream_o_1480688367_GASNetConfig_gen, 
 "$GASNetConfig: (/tmp/upcc--31205-1480688367/stream.trans.c) RELEASE=1.26.3,SPEC=1.8,CONDUIT=IBV(IBV-1.17/IBV-1.13),THREADMODEL=SEQ,SEGMENT=FAST,PTR=64bit,noalign,pshm,nodebug,notrace,nostats,nodebugmalloc,nosrclines,timers_native,membars_native,atomics_native,atomic32_native,atomic64_native $");
GASNETT_IDENT(UPCRI_IdentString_stream_o_1480688367_UPCRConfig_gen,
 "$UPCRConfig: (/tmp/upcc--31205-1480688367/stream.trans.c) VERSION=2.22.3,PLATFORMENV=shared-distributed,SHMEM=pshm,SHAREDPTRREP=packed/p20:t10:a34,TRANS=berkeleyupc,nodebug,nogasp,notv,staticthreads=16 $");
GASNETT_IDENT(UPCRI_IdentString_stream_o_1480688367_translatetime, 
 "$UPCTranslateTime: (stream.o) Fri Dec  2 06:19:27 2016 $");
GASNETT_IDENT(UPCRI_IdentString_stream_o_1480688367_GASNetConfig_obj, 
 "$GASNetConfig: (stream.o) " GASNET_CONFIG_STRING " $");
GASNETT_IDENT(UPCRI_IdentString_stream_o_1480688367_UPCRConfig_obj,
 "$UPCRConfig: (stream.o) " UPCR_CONFIG_STRING UPCRI_THREADCONFIG_STR " $");
GASNETT_IDENT(UPCRI_IdentString_stream_o_1480688367_translator, 
 "$UPCTranslator: (stream.o) /usr/local/upc/2.22.2/translator/install/targ (aphid) $");
GASNETT_IDENT(UPCRI_IdentString_stream_o_1480688367_upcver, 
 "$UPCVersion: (stream.o) 2.22.2 $");
GASNETT_IDENT(UPCRI_IdentString_stream_o_1480688367_compileline, 
 "$UPCCompileLine: (stream.o) /usr/local/upc/2.22.2/runtime/inst/bin/upcc.pl --at-remote-http -translator=/usr/local/upc/2.22.2/translator/install/targ --arch-size=64 --network=ibv -T 16 --lines --trans --sizes-file=upcc-sizes stream.i $");
GASNETT_IDENT(UPCRI_IdentString_stream_o_1480688367_compiletime, 
...
#endif
GASNETT_IDENT(UPCRI_IdentString_stream_o_1480688367_backendcompiler, 
 "$UPCRBackendCompiler: (stream.o) " _STRINGIFY(UPCRI_CC) " $");

#ifdef GASNETT_CONFIGURE_MISMATCH
  GASNETT_IDENT(UPCRI_IdentString_stream_o_1480688367_configuremismatch, 
   "$UPCRConfigureMismatch: (stream.o) 1 $");
  GASNETT_IDENT(UPCRI_IdentString_stream_o_1480688367_configuredcompiler, 
   "$UPCRConfigureCompiler: (stream.o) " GASNETT_PLATFORM_COMPILER_IDSTR " $");
  GASNETT_IDENT(UPCRI_IdentString_stream_o_1480688367_buildcompiler, 
   "$UPCRBuildCompiler: (stream.o) " PLATFORM_COMPILER_IDSTR " $");
#endif

/**************************************************************************/
GASNETT_IDENT(UPCRI_IdentString_stream_o_1480688367_transver_2,
